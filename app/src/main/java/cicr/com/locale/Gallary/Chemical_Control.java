...
//        });
    ...
    public void onButtonClickListner(int position, String value) {
      ...
      //  startActivity(insecticide);
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Chemical_Control.this);
...
//        alertDialog.show();
        ...
        // Get Title from global/application context
        final String Title = globalVariable.getTitle();
        TextView txttt,row2text21,row2text22,row2text23,row2text24,row2text25,row2text26,row2text27,txt1,txt2,txt3,txt4,txt5,txt6;
        String insecticide_brand = value;
        Button dialogButton = (Button) convertView.findViewById(R.id.button_close);
        // if button is clicked, close the custom dialog
        dialogButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ad.dismiss();
             //    Intent insecticide = new Intent(Chemical_Control.this,Chemical_Control.class);
             //   Toast.makeText(Chemical_Control.this,value,Toast.LENGTH_LONG).show();
              //   insecticide.putExtra("insecticide_brand",value);
             //     startActivity(insecticide);
            }
        ...
        row2text21 = (TextView) convertView.findViewById(R.id.row2text21);
        row2text22 = (TextView) convertView.findViewById(R.id.row2text22);
        row2text23 = (TextView) convertView.findViewById(R.id.row2text23);
        row2text24 = (TextView) convertView.findViewById(R.id.row2text24);
        row2text25 = (TextView) convertView.findViewById(R.id.row2text25);
        row2text26 = (TextView) convertView.findViewById(R.id.row2text26);
